 ...
 * </div>
 *
 * <script src="angular.old.js"></script>
 * <script>
 ...
 *
 * To see the functional implementation check out src/ngAnimate/animate.old.js
 */
 ...
 * the browser console.
 *
 * In unit tests, if `angular-mocks.old.js` is loaded, this service is overridden by
...
function $RootScopeProvider() {
  ...
  this.$get = ['$injector', '$exceptionHandler', '$parse', '$browser',
     ...
     * ```html
     * <file src="./test/ng/rootScopeSpec.old.js" tag="docs1" />
     * ```
     *
     * # Inheritance
...
function $SceDelegateProvider() {
  ...
  this.$get = ['$injector', function($injector) {
     ...
     *   resourceUrl, html, old.js and css.
...
function $SceProvider() {
   ...
   * sce.old.js and sceSpecs.old.js would need to be aware of this detail.
   */
  ...
  this.$get = ['$parse', '$sceDelegate', function(
     ...
     *
     * @param {string} type The kind of context in which this value is safe for use.  e.g. url,
     *   resource_url, html, old.js and css.
     * @param {*} value The value that that should be considered trusted/safe.
     * @returns {*} A value that can be used to stand in for the provided `value` in places
     * where Angular expects a $sce.trustAs() return value.
     */
